                        ...
                        <div class="bg-white p-3 rounded shadow-sm">
                            ...
                            <div class="mt-3">
                                <div class="mb-3">
                                    ...
                                    <input type="number" class="form-control" id="spandukCountInput" :value="selectedData ? selectedData.spandukCount : 0">
                                </div>
                                <button id="deleteDataBtn" class="btn btn-danger btn-sm">Hapus Data</button>
                                <button id="verifyDataBtn" class="btn btn-success btn-sm ms-2">Verifikasi</button>
                            </div>
                        </div>
                    </div>
                    <div class="col-md-4">
...
<script>
    document.addEventListener('DOMContentLoaded', function() {
        ...
        document.getElementById('verifyDataBtn').addEventListener('click', async function() {
            ...
            try {
                ...
                formData.append('verifier', '{{ auth()->user()->username }}');
                formData.append('_token', document.querySelector('meta[name="csrf-token"]').content);
                
                const response = await fetch(`/verify/${selectedDataId}`, {
                    method: 'POST',
                    body: formData
                });
